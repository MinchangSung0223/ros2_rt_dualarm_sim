...
public:
    ...
    void addScurveRelativeJointTrajectory(const relmr::JVec& q0,const relmr::JVec& q1,const relmr::JVec& qdot0,const relmr::JVec& qdot1,const relmr::JVec& qddot0,const relmr::JVec& qddot1,double t0,double t1,double dt,int trajType);
